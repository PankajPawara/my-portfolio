  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-16">
      <div className="flex flex-col items-center justify-center text-center bg-gray-900 text-white">
        ...
        <p className="text-xl text-gray-300 mb-8">Full Stack Developer | Problem Solver | Tech Enthusiast</p>
        ...
        <div className="flex gap-4">
          <Link to="/projects" className="px-6 py-3 bg-purple-600 rounded-lg hover:bg-purple-700">View Projects</Link>
          <Link to="/contact" className="px-6 py-3 border border-purple-600 rounded-lg hover:bg-purple-600 hover:text-white">Contact Me</Link>
        </div>
      </div>
      ...
      <h2 className="text-2xl font-bold text-purple-400 mb-4">What I’m Currently Working On?</h2>
      <p className="text-lg text-gray-300 leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-purple-400 mb-4">What I’m Passionate About?</h2>
      <p className="text-lg text-gray-300 leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-purple-400 mb-4">My Tech Journey (Diploma → Degree → Projects)</h2>
